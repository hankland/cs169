...
/* Error codes. */
SUCCESS = 0;
BAD_USER_ERROR = -100; /* Generic error for failed validation. */
BAD_PASSWORD_ERROR = -101; /* Incorrect password for given user. */
EXISTS_ERROR = -110; /* User already exists. */
NOT_EXISTS_ERROR = -111; /* User doesn't exist. */
